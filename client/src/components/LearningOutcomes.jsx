...
const LearningOutcomes = () => {
  return (
    <section id="outcomes" className="py-20 bg-white relative overflow-hidden">
      {/* Background circles */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {learningOutcomes.map((outcome, index) => {
            ...
            return (
              <div
                key={outcome.id}
                className={`group relative bg-white border border-slate-100 p-8 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1.5 flex flex-col justify-between ${
              ...
              >
                ...
                <div className="flex items-center gap-2 border-t border-slate-100 pt-4 text-xs font-semibold text-slate-500 uppercase tracking-wider">
