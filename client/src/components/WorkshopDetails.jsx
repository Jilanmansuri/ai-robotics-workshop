...
const WorkshopDetails = () => {
  return (
    <section id="details" className="py-20 bg-slate-50 dark:bg-slate-950 relative transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
          {workshopDetails.map((detail) => {
            ...
            return (
              <div
                key={detail.id}
                className="group relative bg-white/70 dark:bg-slate-900/60 backdrop-blur-md border border-slate-200/60 dark:border-slate-800 p-6 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2 flex flex-col items-center text-center justify-between"
              >
                ...
                {/* Icon Container */}
                <div className={`p-4 rounded-2xl bg-slate-100/80 dark:bg-slate-800/80 group-hover:bg-primary group-hover:text-white transition-all duration-300 mb-5 ${detail.color}`}>
